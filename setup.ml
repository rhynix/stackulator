...
(* OASIS_START *)
(* DO NOT EDIT (digest: 762c7dba64594b6d52233016d69d2b8d) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_stackula", []))];
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_stackula"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\140\030\134· \135©&=ôð\154·EjR";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
